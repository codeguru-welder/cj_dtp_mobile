...
<div id="mailRegDialog" title="<mink:message code='mink.web.text.regist.mail.serverinfo'/>" class="dlgStyle">
<div class="miaps-popup-top-buttons">
	...
	<span><button class='btn-dash' onclick="javascript:$('#mailRegDialog').dialog('close');"><mink:message code="mink.web.text.cancel"/></button></span>
</div>
	<!-- 등록화면 -->
	<form id="insertFrm" name="insertFrm" method="post"
		...
		<table class="insertTb" border="0" cellspacing="0" cellpadding="0"
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="inboxName" value="INBOX" /></td>
				...
				<tr>
					...
					<td><input type="text" name="outboxName" value="<mink:message code='mink.web.text.mail.outbox'/>" /></td>
				...
				<tr>
					...
					<td><input type="text" name="sentName" value="<mink:message code='mink.web.text.mail.sendbox'/>" /></td>
				...
				<tr>
					...
					<td><input type="text" name="draftsName" value="<mink:message code='mink.web.text.mail.tempbox'/>"/></td>
				...
				<tr>
					...
					<td><input type="text" name="trashName" value="<mink:message code='mink.web.text.mail.recycle'/>" /></td>
		...
		<!-- <div class="insertBtnArea">
			<span><button class='btn-dash'
				...
				<button class='btn-dash' onclick="javascript:hiddenInsertDetail();">취소</button></span>
		</div> -->
	</form>
</div>
...
<script type="text/javascript">
	...
	function openInsertDialog() {
		...
		$("#mailRegDialog").dialog("open");
	}

	$("#mailRegDialog").dialog({
		autoOpen : false,
		resizable : false,
		width : 'auto',
		modal : true,
