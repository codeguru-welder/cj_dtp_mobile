...
//			f.platformName.value = "2000013";
	...
	function login() {
		...
		if(form.portalShopCode.value == "") {
			alert("매장코드를 입력해주세요.");
			return;
		}
		
		if(form.portalPhone.value == "" || isNaN(form.portalPhone.value) == true) {
			alert("전화번호를 정확히 입력해주세요.");
			return;
		}
		
		if(form.portalPassword.value == "") {
			alert("비밀번호를 입력해주세요.");
			return;
		}
...
<div id="mobileWrap">
	...
	<div id="contentsWrap">	
		<form name="mink_login_form" id="loginform" method="post" action="" >
			<fieldset>
			<legend>Login</legend>
			<div class="login_brd_wrap">
				...
				<div class="login_wrap">
					...
					<dl>
						...
						<dd><input type="text" name=portalShopCode id="portalShopCode" maxlength="30" value="" tabindex="1"  title="kunnr" /></dd>
						<dt><label for="id">전화번호</label></dt>
						<dd><input type="text" name="portalPhone" id="portalPhone" maxlength="30" value="" tabindex="1"  title="tel" /></dd>
						<dt><label for="userPw">비밀번호</label></dt>
						<dd>
							<input type="hidden" name="platformName" id="platformName"/>
							<input type="password" name="portalPassword" id="portalPassword" autocomplete="off" maxlength="32" value="" tabindex="2" title="pwd" />
						</dd>
					</dl>
					<p class="id_save">
