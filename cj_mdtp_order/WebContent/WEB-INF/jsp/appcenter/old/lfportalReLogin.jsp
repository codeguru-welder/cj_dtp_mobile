			...
			<div class="login_brd_wrap">
				...
				<div class="login_wrap">
					...
					<dl>
						...
						<dd><input type="text" name="portalShopCode" id="portalShopCode" maxlength="30" value="" tabindex="1"  title="userid" /></dd>
						...
						<dd>
							...
							<input type="password" name="portalPassword" id="portalPassword" autocomplete="off" maxlength="32" value="" tabindex="2" title="password" />
						</dd>
					</dl>
					<p class="id_save">
