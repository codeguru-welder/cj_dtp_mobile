...
//			f.platformName.value = "2000013";
	...
	function login() {
		...
		form.action = "oldMinkLogin_checkM.miaps";
		form.submit();
	}
...
<div id="mobileWrap">
	...
	<div id="contentsWrap">	
		...
		<input type="hidden" name="packageNm" id="packageNm" value="com.lfcorp.miaps.sams"/>
			<fieldset>
			<legend>Login</legend>
			<div class="login_brd_wrap">
				...
				<div class="login_wrap">
					<dl>
			       		<c:if test="${validUser == 'N'}">
							<p class="notice_save2" ><mink:message code='mink.message.not_match_id_pwd' text='<font color=red>입력하신 아이디 혹은 비밀번호가  
								<br />일치하지 않습니다. </font>'/>
							</p>
			       		</c:if>
					</dl>
					<dl>
						...
						<dd><input type="text" name="kunnr" id="kunnr" maxlength="30" value="" tabindex="1"  title="kunnr" /></dd>
						<dt><label for="id">전화번호</label></dt>
						<dd><input type="text" name="tel" id="tel" maxlength="30" value="" tabindex="1"  title="tel" /></dd>
						<dt><label for="userPw"><mink:message code='mink.label.password' text='비밀번호'/></label></dt>
						<dd>
							...
							<input type="password" name="pwd" id="pwd" autocomplete="off" maxlength="32" value="" tabindex="2" title="pwd" />
						</dd>
					</dl>
					<p class="id_save">
				...
				<p class="notice_save3" ><mink:message code='mink.message.id_pwd.input' text='아이디와 비밀번호를 입력하세요.'/></p>
