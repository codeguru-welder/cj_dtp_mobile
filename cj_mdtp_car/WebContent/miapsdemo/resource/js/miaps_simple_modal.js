...
var miapsModal = {
  ...
  appendForm: function () {
    $('body').append(
        ...
        + '    <button class="type-confirm btn-cancel" onclick="miapsModal.onCancel()">취소</button>'
        + '    <button class="type-confirm btn-confirm" onclick="miapsModal.onConfirm()">확인</button>'
