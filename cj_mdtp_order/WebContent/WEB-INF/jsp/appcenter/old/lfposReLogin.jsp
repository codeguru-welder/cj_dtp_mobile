			...
			<div class="login_brd_wrap">
				...
				<div class="login_wrap">
					...
					<dl>
						...
						<dd><input type="text" name="posShopCode" id="posShopCode" maxlength="30" value="" tabindex="1"  title="userid" /></dd>
						...
						<dd>
							...
							<input type="password" name="posPassword" id="posPassword" autocomplete="off" maxlength="32" value="" tabindex="2" title="password" />
						</dd>
					</dl>
					<p class="id_save">
