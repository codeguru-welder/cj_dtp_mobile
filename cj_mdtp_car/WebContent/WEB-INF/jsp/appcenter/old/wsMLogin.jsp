		...
		<input type="hidden" name="platformName" id="platformName"/>
			...
			<div class="login_brd_wrap">
				...
				<div class="login_wrap">
					...
					<dl>
						<dt><label for="id"><mink:message code='mink.label.user_id' text='사용자ID'/></label></dt>
						<dd><input type="text" name="userid" id="userid" maxlength="30" value="" tabindex="1"  title="userid" /></dd>
						...
						<dd>
							...
							<input type="password" name="userpassword" id="userpassword" autocomplete="off" maxlength="32" value="" tabindex="2" title="password" />
						</dd>
					</dl>
					<p class="id_save">
